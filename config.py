...
def get_config(training = True):
   ...
   # conf.train_list = '/tmp/yuxi.feng/4@2.det'
    ...
    conf.test_list = '/mnt/cephfs/smartauto/users/guoli.wang/jiachen.xue/anti_spoofing/data/CASIA-CeFA/phase1/4@1_dev_res.txt' #path where test list is, you should change it according to your setting
   # conf.test_list = '/tmp/yuxi.feng/4@1_test.det'
    conf.batch_size = 128

    conf.exp = 'phase1_multi_4@1_lr_0.01_epoch_30_input_size_256_emd_128_dropout_0.0_wo_se_offset_32'
...
#--------------------Inference Config ------------------------
       ...
       # conf.test.set = 'phase2_test'
        ...
        conf.test.epoch_start = 0
        conf.test.epoch_end = 30
        conf.test.epoch_interval = 1 #we set a range of epoches for testing
