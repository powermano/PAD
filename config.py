...
def get_config(training = True):
   ...
   # conf.test_list = '/mnt/cephfs/smartauto/users/guoli.wang/jiachen.xue/anti_spoofing/data/CASIA-CeFA/phase1/4@3_dev_res.txt' #path where test list is, you should change it according to your setting
    conf.batch_size = 128
    conf.exp = 'phase1_4@3_lr_0.001_epoch_30_input_size_384_emd_128_dropout_0.0_triplet_ratio_0.001' #model is saved in conf.save_path/conf.exp, if you want to train different models, you can distinguish them according to this parameter
