...
def get_config(training = True):
    ...
    conf.ir = False
    conf.crop = True
    conf.use_label_smoothing = False
    ...
    conf.train_list =  '/mnt/cephfs/smartauto/users/guoli.wang/jiachen.xue/anti_spoofing/data/CASIA-CeFA/phase1/4@3_train.det' #path where training list is, you should change it according to your setting
   # conf.train_list = '/home/users/tao.cai/4@1_train.txt'
   # conf.train_list = '/tmp/yuxi.feng/IR/4@2_train.txt'
   # conf.test_list = '/tmp/yuxi.feng/IR/4@2_test.txt'
   # conf.test_list = '/mnt/cephfs/smartauto/users/guoli.wang/jiachen.xue/anti_spoofing/data/CASIA-CeFA/phase1/4@1_test_res.txt'
    conf.test_list = '/mnt/cephfs/smartauto/users/guoli.wang/jiachen.xue/anti_spoofing/data/CASIA-CeFA/phase1/4@2_test.det' #path where test list is, you should change it according to your setting
   # conf.test_list = '/tmp/yuxi.feng/4@1_test.det'
    conf.batch_size = 128

    conf.exp = 'phase1_4@2_resnet18_lr_0.01_epoch_30_input_size_128_emd_512_dropout_0.0_triplet_ratio_0.01_crop_offset_16'
   ...
   # conf.exp = 'phase1_4@1_lr_0.001_epoch_30_input_size_384_emd_128_dp_0_wo_mo_add_128_bs_128_fix'
    ...
    conf.model.input_size = 128 #the input size of our model
    conf.model.random_offset = 16 #for random crop
...
#--------------------Training Config ------------------------
    if training:
        ...
        conf.train.milestones = [10, 15, 20, 25] #epoch milestones decreased by a factor of 10
...
#--------------------Inference Config ------------------------
       ...
       # conf.test.set = '4@1_test'
        conf.test.epoch_start = 5
        conf.test.epoch_end = 30
        conf.test.epoch_interval = 4 #we set a range of epoches for testing
